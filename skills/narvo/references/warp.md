...
preview:
  ...
  accent: '#353534'
summary: >-
  Warm near-black rather than cold. Parchment #faf9f6 text, Matter Regular everywhere, almost no color.
colors:
  background: '#1a1918' # approximated: no page-background hex in source
  text-primary: '#faf9f6'
